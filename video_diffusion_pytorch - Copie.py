...
class Trainer(object):
    def __init__(
        ...
        *,
        ...
        step_start_ema=2000,
        update_ema_every=10,
        save_and_sample_every=1000,  # Modifiez cette valeur pour tester plus fréquemment
        results_folder='./results',
        num_sample_rows=4,
        max_grad_norm=None
    ):
        super().__init__()
        self.model = diffusion_model.to(device)  # Ensure the model is on the right device
...
if __name__ == "__main__":
    ...
    diffusion_model = GaussianDiffusion(denoise_fn=denoise_fn, image_size=64, num_frames=8, channels=3).to(device)
